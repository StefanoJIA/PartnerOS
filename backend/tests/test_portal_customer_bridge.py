...
def test_portal_customer_manifest_is_token_gated_and_safe():
    ...
    assert "customer_timeline" in data["field_contract"]
    assert "customer_timeline_item" in data["field_contract"]
    assert "customer_timeline" in data["field_contract"]["snapshot"]
