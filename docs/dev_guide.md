...
5. Start D9 operating loops only after `STAGING_VALIDATED`, `READY_FOR_PRODUCTION_COORDINATION_REVIEW`, production coordination, and the human Go / No-Go handoff. If that decision is committed, use `docs/records/d8_production_go_no_go_YYYYMMDD.md`.
