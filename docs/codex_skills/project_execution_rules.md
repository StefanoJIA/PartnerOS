...
- Run `python scripts/project_execution_chain_gate_check.py`, `python scripts/staging_evidence_boundary_check.py`, `python scripts/d8_staging_execution_pack_check.py`, `python scripts/project_execution_acceptance_audit_check.py`, and `python scripts/project_execution_status.py` before claiming the current stage.
