...
| D9 Operating Execution Pack | Aggregate all D9 operating-loop gates before the first review | `docs/phase3/d9_operating_execution_pack.md` | `python scripts/d9_operating_execution_pack_check.py` | Planned | Run after D8 production coordination and before first D9 record |
| D9 Operating Loop Kickoff | Define the first post-coordination D9 review session | `docs/phase3/d9_operating_loop_kickoff.md` | `python scripts/d9_operating_loop_kickoff_check.py` | Planned | Run only after D8 production coordination |
