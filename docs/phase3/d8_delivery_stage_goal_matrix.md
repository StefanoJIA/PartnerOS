...
| D8 Local Staging Rehearsal | Practice the strict staging command order locally without claiming staging validation | `docs/phase3/d8_local_staging_rehearsal.md` | `python scripts/d8_local_staging_rehearsal_check.py` | Added | Optional before real staging; not a substitute for saved staging evidence |
...
| D8 Staging Handoff Bundle | Define the exact docs and commands to share before strict staging | `docs/phase3/d8_staging_handoff_bundle.md` | `python scripts/d8_staging_handoff_bundle_check.py` | Added | Use as the operator-facing handoff manifest |
...
| D9 Post-Launch Operating Loop | Plan the monitored operating loop after production coordination and evidence review | `docs/phase3/d9_post_launch_operating_loop.md` | `python scripts/d9_post_launch_plan_check.py` | Planned | Starts only after D8 production coordination and `READY_FOR_PRODUCTION_COORDINATION_REVIEW` |
| D9 Operating Execution Pack | Aggregate all D9 operating-loop gates before the first review | `docs/phase3/d9_operating_execution_pack.md` | `python scripts/d9_operating_execution_pack_check.py` | Planned | Run after D8 production coordination and evidence review before first D9 record |
| D9 Operating Loop Kickoff | Define the first post-coordination D9 review session | `docs/phase3/d9_operating_loop_kickoff.md` | `python scripts/d9_operating_loop_kickoff_check.py` | Planned | Run only after D8 production coordination and evidence review |
...
| Project Execution Chain Gate | Aggregate local planning, readiness, handoff, and records gates before staging handoff | `docs/phase3/project_execution_chain_gate.md` | `python scripts/project_execution_chain_check.py` | Added | Use as the top-level local gate before strict staging handoff |
...
If the operator wants to rehearse the command order locally first, use [D8 Local Staging Rehearsal](d8_local_staging_rehearsal.md). Rehearsal output is not staging proof and must not change the readiness state to `STAGING_VALIDATED`.
