# PartnerOS Demo Package

Status: READY_FOR_STAGING_HANDOFF

This folder contains the partner-facing demo and staging handoff package for PartnerOS.

## Core Demo Materials

- [Partner-facing demo script](partner_demo_script.md)
...
- [Sales operating kit](sales_operating_kit.md)
- [Demo walkthrough checklist](demo_walkthrough_checklist.md)
- [D8.6 live walkthrough QA](d8_6_live_walkthrough_qa.md)
