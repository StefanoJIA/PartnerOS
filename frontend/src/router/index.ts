...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/admin/login', name: 'login', component: () => import('@/pages/auth/LoginPage.vue'), meta: { public: true } },
    {
      path: '/admin',
      ...
      children: [
        ...
        { path: 'staging-readiness', redirect: '/admin/external-execution' },
        { path: 'portal-consumer-mock', redirect: '/admin/portal-customer-bridge' },
        { path: 'portal-operations', redirect: '/admin/portal-integration' },
        ...
        { path: 'project-requests', name: 'project-requests', component: () => import('@/pages/project-requests/ProjectRequestsPage.vue') },
        { path: 'project-requests/:requestId', name: 'project-request-detail', component: () => import('@/pages/project-requests/ProjectRequestDetailPage.vue') },
        { path: 'supplier-discovery', name: 'supplier-discovery', component: () => import('@/pages/suppliers/SupplierDiscoveryPage.vue') },
        { path: 'category-coverage', name: 'category-coverage', component: () => import('@/pages/suppliers/CategoryCoveragePage.vue') },
        { path: 'commercial-pilot-operations', name: 'commercial-pilot-operations', component: () => import('@/pages/suppliers/CommercialPilotOperationsPage.vue') },
        { path: 'benchmark-knowledge', name: 'benchmark-knowledge', component: () => import('@/pages/market/BenchmarkKnowledgePage.vue') },
        { path: 'platform-intelligence', name: 'platform-intelligence', component: () => import('@/pages/market/PlatformIntelligencePage.vue') },
        ...
        { path: 'market-response', redirect: '/admin/market-intelligence' },
